...
$serviceManager->setAlias('kp2', 'kp');
echo $serviceManager->get('kp2')->url;

echo "<hr>";
if ($serviceManager->get('kp') === $serviceManager->get('kp2')) {
    echo "Alias and original are same instance.<br>";
} else {
    echo "Alias and original are different instance.<br>";
}
